  ...
  return (
    <div className="relative py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-custom-pink-light to-white">
      ...
      <div className="relative max-w-3xl mx-auto">
        <div className="absolute left-6 md:left-1/2 w-0.5 h-full bg-custom-pink-dark transform md:-translate-x-1/2 z-0"></div>
        ...
        {invitationData.loveStory.map((story, index) => {
          ...
          return (
            ...
            >
              ...
              <div className="absolute top-1/2 left-6 md:left-1/2 -translate-y-1/2 -translate-x-1/2 w-4 h-4 bg-custom-pink-dark rounded-full border-2 border-white z-10"></div>
            </div>
          );
        })}
      </div>
