            ...
            >
              <div className={`w-full pl-12 md:w-1/2 ${isLeftOnDesktop ? 'md:pr-12 md:pl-0' : 'md:pl-12'}`}>
                ...
                >
                  ...
                  <div className="w-full md:w-7/12 backdrop-blur-[8px] border-t md:border-t-0 md:border-l border-white/20 p-5 flex items-center justify-center">
                    <p className="font-sans text-[15px] md:text-[15px] leading-relaxed text-center drop-shadow-sm">
                      {story.description}
                    </p>
                  </div>
                </div>
