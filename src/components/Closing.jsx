...
const Closing = () => {
  ...
  return (
    <div className="relative overflow-hidden y-20 px-6 text-center bg-gradient-to-b from-white to-blue-300">
      <img src={`${cdnBaseUrl}fern-group-1.webp`} alt="Ornamen Fern Bawah" className="absolute bottom-[-4px] left-[0px] w-[300px] max-w-md h-auto z-0 scale-x-[-1]"
      />
      <img src={`${cdnBaseUrl}fern-group-1.webp`} alt="Ornamen Fern Bawah" className="absolute bottom-[-4px] right-[-100px] w-[300px] max-w-md h-auto z-0"
      />
