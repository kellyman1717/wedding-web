...
const ProfileCard = ({ name, fullName, father, mother, photo }) => (
  <div className="flex flex-col items-center gap-4">
    ...
    <div className="text-center">
      <p className="font-semibold">Putra dari Pasangan</p>
      <p>{father}</p>
      <p>&</p>
      <p>{mother}</p>
    </div>
  ...
  return (
    <div className="text-center py-16 px-6 bg-custom-pink-light">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-12 md:gap-20">
        <ProfileCard name={invitationData.groom} {...invitationData.groomProfile} />
        <span className="font-display text-5xl text-custom-pink-dark">&</span>
        <ProfileCard name={invitationData.bride} {...invitationData.brideProfile} />
      </div>
    </div>
  );
};
