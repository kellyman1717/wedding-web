...
const Gallery = () => {
  ...
  return (
    <div className="relative py-16 px-8 sm:px-6 lg:px-8 bg-custom-blue-light">
      {/* Ornamen Bunga */}
      <img src={`${cdnBaseUrl}leaf-5.webp`} alt="Ornamen" className="absolute top-[50px] left-[-55px] w-[160px] h-auto z-0 scale-y-[-1] opacity-75"/>
      <img src={`${cdnBaseUrl}leaf-5.webp`} alt="Ornamen" className="absolute top-[50px] right-[-55px] w-[160px] h-auto z-0 rotate-[180deg] opacity-75"/>
      <img src={`${cdnBaseUrl}floral-bouquet-17.webp`} alt="Ornamen" className="absolute top-[-15px] left-[-15px] w-[170px] h-auto z-0 scale-y-[-1]"/>
      <img src={`${cdnBaseUrl}floral-bouquet-17.webp`} alt="Ornamen" className="absolute top-[-15px] right-[-15px] w-[170px] h-auto z-0 rotate-[180deg]"/>
      <img src={`${cdnBaseUrl}floral-straight-7.webp`} alt="Ornamen" className="absolute top-[-50px] left-1/2 -translate-x-1/2 w-[215px] h-auto z-10 opacity-90"/>
      <img src={`${cdnBaseUrl}floral-straight-1.webp`} alt="Ornamen" className="absolute top-[-50px] left-0 w-[230px] h-auto z-0"/>
      <img src={`${cdnBaseUrl}floral-straight-1.webp`} alt="Ornamen" className="absolute top-[-48px] right-[-23px] w-[230px] h-auto z-0 rotate-180"/>
      <img src={`${cdnBaseUrl}leaf-branches-8.webp`} alt="Ornamen" className="absolute bottom-[-0px] right-[-0px] w-[143px] h-auto z-0 opacity-90"/>
      <img src={`${cdnBaseUrl}leaf-branches-9.webp`} alt="Ornamen" className="absolute bottom-[340px] left-[-40px] w-[143px] h-auto z-0 rotate-[100deg] scale-y-[-1] opacity-90"/>
      <img src={`${cdnBaseUrl}leaf-branches-10.webp`} alt="Ornamen" className="absolute bottom-[585px] right-[-40px] w-[143px] h-auto z-0 scale-x-[-1] opacity-90"/>
