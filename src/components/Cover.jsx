...
const Cover = ({ onOpen }) => {
  ...
  const flower1FallbackCdn = `${cdnBaseUrl}top-right-1.svg`;
  const flower2FallbackCdn = `${cdnBaseUrl}flower-cover-top-right.svg`;
  const bgCoverFallbackCdn = `${cdnBaseUrl}bg-cover4.jpg`
